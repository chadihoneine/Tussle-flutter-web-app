...
class TournamentDetailPage extends StatefulWidget {
  ...
  @override
  _TournamentDetailPage createState() => _TournamentDetailPage();
}

class _TournamentDetailPage extends State<TournamentDetailPage>
  ...
  Widget build(BuildContext context) {
    headerImageSize = MediaQuery.of(context).size.height / 3;
